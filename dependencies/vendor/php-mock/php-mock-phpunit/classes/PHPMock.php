...
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\phpmock\phpunit;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\phpmock\integration\MockDelegateFunctionBuilder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\phpmock\MockBuilder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\phpmock\Deactivatable;
...
trait PHPMock
{
    ...
    {
        $functionMockBuilder = new MockBuilder();
        $functionMockBuilder->setNamespace($namespace)->setName($name)->setFunction(function () {
        })->build()->define();
    }
}
