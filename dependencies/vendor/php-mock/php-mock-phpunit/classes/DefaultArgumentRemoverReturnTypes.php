...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\phpmock\generator\MockFunctionGenerator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\Invocation;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\Matcher\Invocation as InvocationInterface;
/**
...
class DefaultArgumentRemoverReturnTypes implements InvocationInterface
{
    ...
    public function matches(Invocation $invocation) : bool
    {
        ...
        if ($iClass || $invocation instanceof Invocation\StaticInvocation) {
            $this->removeDefaultArguments($invocation, $iClass ? Invocation::class : Invocation\StaticInvocation::class);
        } else {
