 ...
 * @license MIT
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Dealerdirect\Composer\Plugin\Installers\PHPCodeSniffer;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Composer;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\EventDispatcher\EventSubscriberInterface;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\IO\IOInterface;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Package\AliasPackage;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Package\PackageInterface;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Package\RootPackageInterface;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Plugin\PluginInterface;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Script\Event;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Script\ScriptEvents;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Util\Filesystem;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Util\ProcessExecutor;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Symfony\Component\Finder\Finder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Symfony\Component\Process\Exception\LogicException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Symfony\Component\Process\Exception\ProcessFailedException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Symfony\Component\Process\Exception\RuntimeException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Symfony\Component\Process\PhpExecutableFinder;
/**
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    {
        if ($this->isPHPCodeSnifferInstalled() === \true) {
            $this->processExecutor->execute('phpcs --config-show', $output, $this->composer->getConfig()->get('bin-dir'));
