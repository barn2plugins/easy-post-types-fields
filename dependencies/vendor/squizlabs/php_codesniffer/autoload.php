...
if (\class_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CodeSniffer\\Autoload', \false) === \false) {
    class Autoload
    {
        /**
        ...
        public static function load($class)
        {
            ...
            if (self::$composerAutoloader === null) {
                ...
                if (\strpos(__DIR__, 'phar://') !== 0 && @\file_exists(__DIR__ . '/../../autoload.php') === \true) {
                    ...
                    if (self::$composerAutoloader instanceof \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Autoload\ClassLoader) {
