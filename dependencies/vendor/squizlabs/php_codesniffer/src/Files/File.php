 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Files;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Ruleset;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Config;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Fixer;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Exceptions\TokenizerException;
class File
{
    /**
    ...
    public function process()
    {
        ...
        $foundCode = \false;
        $listenerIgnoreTo = [];
        $inTests = \defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS');
