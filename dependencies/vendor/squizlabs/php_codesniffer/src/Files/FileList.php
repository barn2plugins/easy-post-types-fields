...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Autoload;
...
class FileList implements \Iterator, \Countable
{
    ...
    private function getFilterClass()
    {
        ...
        if ($filterType === null) {
            $filterClass = 'Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CodeSniffer\\Filters\\Filter';
        } else {
