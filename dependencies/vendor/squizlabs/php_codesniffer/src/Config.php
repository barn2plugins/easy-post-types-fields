...
class Config
{
    ...
    {
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS') === \true) {
            ...
            default:
                if (\substr($arg, 0, 7) === 'sniffs=') {
                    ...
                    if (\substr($arg, 0, 8) === 'exclude=') {
                        ...
                        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS') === \false && \substr($arg, 0, 6) === 'cache=') {
