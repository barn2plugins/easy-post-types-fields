 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Exceptions\DeepExitException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Exceptions\RuntimeException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Files\DummyFile;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Files\File;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Files\FileList;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Util\Cache;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Util\Common;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Util\Standards;
class Runner
{
    /**
    ...
    public function runPHPCS()
    {
        try {
            ...
            if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_CBF') === \false) {
                \define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_CBF', \false);
            }
    ...
    {
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_CBF') === \false) {
            \define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_CBF', \true);
        }
        try {
            Util\Timing::startTiming();
            Runner::checkRequirements();
    ...
    public function init()
    {
        ...
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_VERBOSITY') === \false) {
            \define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_VERBOSITY', $this->config->verbosity);
        }
