 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Util;

\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_NONE', 'PHPCS_T_NONE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OPEN_CURLY_BRACKET', 'PHPCS_T_OPEN_CURLY_BRACKET');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_CURLY_BRACKET', 'PHPCS_T_CLOSE_CURLY_BRACKET');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OPEN_SQUARE_BRACKET', 'PHPCS_T_OPEN_SQUARE_BRACKET');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_SQUARE_BRACKET', 'PHPCS_T_CLOSE_SQUARE_BRACKET');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OPEN_PARENTHESIS', 'PHPCS_T_OPEN_PARENTHESIS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_PARENTHESIS', 'PHPCS_T_CLOSE_PARENTHESIS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_COLON', 'PHPCS_T_COLON');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_NULLABLE', 'PHPCS_T_NULLABLE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_STRING_CONCAT', 'PHPCS_T_STRING_CONCAT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_INLINE_THEN', 'PHPCS_T_INLINE_THEN');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_INLINE_ELSE', 'PHPCS_T_INLINE_ELSE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_NULL', 'PHPCS_T_NULL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_FALSE', 'PHPCS_T_FALSE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_TRUE', 'PHPCS_T_TRUE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_SEMICOLON', 'PHPCS_T_SEMICOLON');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_EQUAL', 'PHPCS_T_EQUAL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_MULTIPLY', 'PHPCS_T_MULTIPLY');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DIVIDE', 'PHPCS_T_DIVIDE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PLUS', 'PHPCS_T_PLUS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_MINUS', 'PHPCS_T_MINUS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_MODULUS', 'PHPCS_T_MODULUS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BITWISE_AND', 'PHPCS_T_BITWISE_AND');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BITWISE_OR', 'PHPCS_T_BITWISE_OR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BITWISE_XOR', 'PHPCS_T_BITWISE_XOR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BITWISE_NOT', 'PHPCS_T_BITWISE_NOT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ARRAY_HINT', 'PHPCS_T_ARRAY_HINT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_GREATER_THAN', 'PHPCS_T_GREATER_THAN');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_LESS_THAN', 'PHPCS_T_LESS_THAN');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BOOLEAN_NOT', 'PHPCS_T_BOOLEAN_NOT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_SELF', 'PHPCS_T_SELF');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PARENT', 'PHPCS_T_PARENT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOUBLE_QUOTED_STRING', 'PHPCS_T_DOUBLE_QUOTED_STRING');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_COMMA', 'PHPCS_T_COMMA');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_HEREDOC', 'PHPCS_T_HEREDOC');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PROTOTYPE', 'PHPCS_T_PROTOTYPE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_THIS', 'PHPCS_T_THIS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_REGULAR_EXPRESSION', 'PHPCS_T_REGULAR_EXPRESSION');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PROPERTY', 'PHPCS_T_PROPERTY');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_LABEL', 'PHPCS_T_LABEL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OBJECT', 'PHPCS_T_OBJECT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_OBJECT', 'PHPCS_T_CLOSE_OBJECT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_COLOUR', 'PHPCS_T_COLOUR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_HASH', 'PHPCS_T_HASH');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_URL', 'PHPCS_T_URL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_STYLE', 'PHPCS_T_STYLE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ASPERAND', 'PHPCS_T_ASPERAND');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOLLAR', 'PHPCS_T_DOLLAR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_TYPEOF', 'PHPCS_T_TYPEOF');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSURE', 'PHPCS_T_CLOSURE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ANON_CLASS', 'PHPCS_T_ANON_CLASS');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BACKTICK', 'PHPCS_T_BACKTICK');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_START_NOWDOC', 'PHPCS_T_START_NOWDOC');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_NOWDOC', 'PHPCS_T_NOWDOC');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_END_NOWDOC', 'PHPCS_T_END_NOWDOC');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OPEN_SHORT_ARRAY', 'PHPCS_T_OPEN_SHORT_ARRAY');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_SHORT_ARRAY', 'PHPCS_T_CLOSE_SHORT_ARRAY');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_GOTO_LABEL', 'PHPCS_T_GOTO_LABEL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_BINARY_CAST', 'PHPCS_T_BINARY_CAST');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_EMBEDDED_PHP', 'PHPCS_T_EMBEDDED_PHP');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_RETURN_TYPE', 'PHPCS_T_RETURN_TYPE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_OPEN_USE_GROUP', 'PHPCS_T_OPEN_USE_GROUP');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_CLOSE_USE_GROUP', 'PHPCS_T_CLOSE_USE_GROUP');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ZSR', 'PHPCS_T_ZSR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ZSR_EQUAL', 'PHPCS_T_ZSR_EQUAL');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_FN_ARROW', 'PHPCS_T_FN_ARROW');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_TYPE_UNION', 'PHPCS_T_TYPE_UNION');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PARAM_NAME', 'PHPCS_T_PARAM_NAME');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_MATCH_ARROW', 'PHPCS_T_MATCH_ARROW');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_MATCH_DEFAULT', 'PHPCS_T_MATCH_DEFAULT');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ATTRIBUTE_END', 'PHPCS_T_ATTRIBUTE_END');
...
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_STAR', 'PHPCS_T_DOC_COMMENT_STAR');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_WHITESPACE', 'PHPCS_T_DOC_COMMENT_WHITESPACE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_TAG', 'PHPCS_T_DOC_COMMENT_TAG');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_OPEN_TAG', 'PHPCS_T_DOC_COMMENT_OPEN_TAG');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_CLOSE_TAG', 'PHPCS_T_DOC_COMMENT_CLOSE_TAG');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_DOC_COMMENT_STRING', 'PHPCS_T_DOC_COMMENT_STRING');
// Tokens used for PHPCS instruction comments.
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PHPCS_ENABLE', 'PHPCS_T_PHPCS_ENABLE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PHPCS_DISABLE', 'PHPCS_T_PHPCS_DISABLE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PHPCS_SET', 'PHPCS_T_PHPCS_SET');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PHPCS_IGNORE', 'PHPCS_T_PHPCS_IGNORE');
\define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_PHPCS_IGNORE_FILE', 'PHPCS_T_PHPCS_IGNORE_FILE');
final class Tokens
{
    /**
