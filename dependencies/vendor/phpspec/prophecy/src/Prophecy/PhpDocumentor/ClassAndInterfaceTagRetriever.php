...
final class ClassAndInterfaceTagRetriever implements MethodTagRetrieverInterface
{
    ...
    public function __construct(MethodTagRetrieverInterface $classRetriever = null)
    {
        ...
        $this->classRetriever = \class_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\phpDocumentor\\Reflection\\DocBlockFactory') && \class_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\phpDocumentor\\Reflection\\Types\\ContextFactory') ? new ClassTagRetriever() : new LegacyClassTagRetriever();
    }
    /**
