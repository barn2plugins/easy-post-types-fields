 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Exception\Doubler\DoubleException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Exception\Doubler\ClassNotFoundException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Exception\Doubler\InterfaceNotFoundException;
use ReflectionClass;
/**
 * Lazy double.
