 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\ClassPatch;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator\Node\ArgumentTypeNode;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator\Node\ClassNode;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator\Node\MethodNode;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator\Node\ArgumentNode;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator\Node\ReturnTypeNode;
/**
...
class ProphecySubjectPatch implements ClassPatchInterface
{
    ...
    {
        $node->addInterface('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\Prophecy\\Prophecy\\ProphecySubjectInterface');
        ...
        $prophecyArgument->setTypeNode(new ArgumentTypeNode('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\Prophecy\\Prophecy\\ProphecyInterface'));
