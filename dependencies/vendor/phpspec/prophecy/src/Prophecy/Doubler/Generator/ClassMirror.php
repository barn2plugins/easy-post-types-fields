 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Doubler\Generator;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Prophecy\Exception\Doubler\ClassMirrorException;
use ReflectionClass;
...
class ClassMirror
{
    ...
    public function reflect(?ReflectionClass $class, array $interfaces)
    {
        ...
        $node->addInterface('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\Prophecy\\Doubler\\Generator\\ReflectionInterface');
        return $node;
    }
