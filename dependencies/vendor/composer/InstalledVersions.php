 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer;

use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Autoload\ClassLoader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
