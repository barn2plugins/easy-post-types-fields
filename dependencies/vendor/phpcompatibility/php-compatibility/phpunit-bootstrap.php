 ...
 * @since 5.5
 */
if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS') === \false) {
    \define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS', \true);
}
...
if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_VERBOSITY') === \false) {
    \define('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_VERBOSITY', 0);
}
...
if (\class_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUnit\\Runner\\Version') && \version_compare(PHPUnit\Runner\Version::id(), '6.0', '>=') && \class_exists('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUnit_Framework_TestCase') === \false) {
    \class_alias('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUnit\\Framework\\TestCase', 'Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUnit_Framework_TestCase');
}
