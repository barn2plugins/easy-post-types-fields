...
class ForbiddenNamesAsInvokedFunctionsSniff extends Sniff
{
     ...
     * @var array
     */
    protected $targetedTokens = array(\T_ABSTRACT => '5.0', \T_CALLABLE => '5.4', \T_CATCH => '5.0', \T_FINAL => '5.0', \T_FINALLY => '5.5', \T_GOTO => '5.3', \T_IMPLEMENTS => '5.0', \T_INTERFACE => '5.0', \T_INSTANCEOF => '5.0', \T_INSTEADOF => '5.4', \T_NAMESPACE => '5.3', \T_PRIVATE => '5.0', \T_PROTECTED => '5.0', \T_PUBLIC => '5.0', \T_TRAIT => '5.4', \T_TRY => '5.0');
    /**
     ...
     * @var array
     */
    protected $targetedStringTokens = array('abstract' => '5.0', 'callable' => '5.4', 'catch' => '5.0', 'final' => '5.0', 'finally' => '5.5', 'goto' => '5.3', 'implements' => '5.0', 'interface' => '5.0', 'instanceof' => '5.0', 'insteadof' => '5.4', 'namespace' => '5.3', 'private' => '5.0', 'protected' => '5.0', 'public' => '5.0', 'trait' => '5.4', 'try' => '5.0');
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
         ...
         */
        if ($tokenCode === \T_STRING && isset($this->targetedStringTokens[$tokenContentLc]) === \false) {
            return;
        }
         ...
         */
        if (($tokens[$prev]['code'] === \T_OBJECT_OPERATOR || $tokens[$prev]['code'] === \T_DOUBLE_COLON) && $this->supportsBelow('5.6') === \false) {
            return;
        }
        ...
        if ($tokenCode === \T_CATCH) {
            if ($prev !== \false && $tokens[$prev]['code'] === \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSE_CURLY_BRACKET) {
                // Ok, it's fine.
                return;
            }
        }
        ...
        if ($this->supportsAbove($version)) {
            ...
            $data = array($tokenContentLc, $version, $tokens[$stackPtr]['type']);
