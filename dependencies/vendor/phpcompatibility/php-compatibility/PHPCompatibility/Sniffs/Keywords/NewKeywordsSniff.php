 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\Keywords;
...
class NewKeywordsSniff extends AbstractNewFeatureSniff
{
    ...
    protected $newKeywords = array(
        'T_HALT_COMPILER' => array('5.0' => \false, '5.1' => \true, 'description' => '"__halt_compiler" keyword'),
        'T_CONST' => array('5.2' => \false, '5.3' => \true, 'description' => '"const" keyword', 'condition' => 'isClassConstant'),
        'T_CALLABLE' => array('5.3' => \false, '5.4' => \true, 'description' => '"callable" keyword', 'content' => 'callable'),
        'T_DIR' => array('5.2' => \false, '5.3' => \true, 'description' => '__DIR__ magic constant', 'content' => '__DIR__'),
        'T_GOTO' => array('5.2' => \false, '5.3' => \true, 'description' => '"goto" keyword', 'content' => 'goto'),
        'T_INSTEADOF' => array('5.3' => \false, '5.4' => \true, 'description' => '"insteadof" keyword (for traits)', 'content' => 'insteadof'),
        'T_NAMESPACE' => array('5.2' => \false, '5.3' => \true, 'description' => '"namespace" keyword', 'content' => 'namespace'),
        'T_NS_C' => array('5.2' => \false, '5.3' => \true, 'description' => '__NAMESPACE__ magic constant', 'content' => '__NAMESPACE__'),
        'T_USE' => array('5.2' => \false, '5.3' => \true, 'description' => '"use" keyword (for traits/namespaces/anonymous functions)'),
        'T_START_NOWDOC' => array('5.2' => \false, '5.3' => \true, 'description' => 'nowdoc functionality'),
        'T_END_NOWDOC' => array('5.2' => \false, '5.3' => \true, 'description' => 'nowdoc functionality'),
        'T_START_HEREDOC' => array('5.2' => \false, '5.3' => \true, 'description' => '(Double) quoted Heredoc identifier', 'condition' => 'isNotQuoted'),
        'T_TRAIT' => array('5.3' => \false, '5.4' => \true, 'description' => '"trait" keyword', 'content' => 'trait'),
        'T_TRAIT_C' => array('5.3' => \false, '5.4' => \true, 'description' => '__TRAIT__ magic constant', 'content' => '__TRAIT__'),
        ...
        'T_YIELD_FROM' => array('5.6' => \false, '7.0' => \true, 'description' => '"yield from" keyword (for generators)', 'content' => 'yield'),
        'T_YIELD' => array('5.4' => \false, '5.5' => \true, 'description' => '"yield" keyword (for generators)', 'content' => 'yield'),
        'T_FINALLY' => array('5.4' => \false, '5.5' => \true, 'description' => '"finally" keyword (in exception handling)', 'content' => 'finally'),
    );
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokenType === 'T_YIELD') {
            $nextToken = $phpcsFile->findNext(\T_WHITESPACE, $end + 1, null, \true);
            if ($tokens[$nextToken]['code'] === \T_STRING && $tokens[$nextToken]['content'] === 'from') {
        ...
        $nextToken = $phpcsFile->findNext(Tokens::$emptyTokens, $end + 1, null, \true);
        $prevToken = $phpcsFile->findPrevious(Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        if ($prevToken !== \false && ($tokens[$prevToken]['code'] === \T_DOUBLE_COLON || $tokens[$prevToken]['code'] === \T_OBJECT_OPERATOR)) {
        ...
        // them.
        if (($nextToken === \false || $tokens[$nextToken]['type'] !== 'T_OPEN_PARENTHESIS') && ($prevToken === \false || $tokens[$prevToken]['type'] !== 'T_CLASS' || $tokens[$prevToken]['type'] !== 'T_INTERFACE')) {
            // Skip based on token scope condition.
            if (isset($this->newKeywords[$tokenType]['condition']) && \call_user_func(array($this, $this->newKeywords[$tokenType]['condition']), $phpcsFile, $stackPtr) === \true) {
                return;
            }
            $itemInfo = array('name' => $tokenType);
    ...
    {
        return array('description', 'condition', 'content');
    }
    /**
