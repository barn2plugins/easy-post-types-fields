...
class RemovedIconvEncodingSniff extends AbstractFunctionCallParameterSniff
{
     ...
     * @var array
     */
    protected $targetFunctions = array('iconv_set_encoding' => \true);
    /**
    ...
    public function processParameters(File $phpcsFile, $stackPtr, $functionName, $parameters)
    {
        ...
        $phpcsFile->addWarning('All previously accepted values for the $type parameter of iconv_set_encoding() have been deprecated since PHP 5.6. Found %s', $parameters[1]['start'], 'DeprecatedValueFound', $parameters[1]['raw']);
    }
}
