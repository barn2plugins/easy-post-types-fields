...
class RemovedPCREModifiersSniff extends AbstractFunctionCallParameterSniff
{
     ...
     * @var array
     */
    protected $targetFunctions = array('preg_replace' => \true, 'preg_filter' => \true);
    /**
    ...
    public function processParameters(File $phpcsFile, $stackPtr, $functionName, $parameters)
    {
        ...
        $nextNonEmpty = $phpcsFile->findNext(Tokens::$emptyTokens, $firstParam['start'], $firstParam['end'] + 1, \true);
        if ($nextNonEmpty !== \false && ($tokens[$nextNonEmpty]['code'] === \T_ARRAY || $tokens[$nextNonEmpty]['code'] === \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_SHORT_ARRAY)) {
