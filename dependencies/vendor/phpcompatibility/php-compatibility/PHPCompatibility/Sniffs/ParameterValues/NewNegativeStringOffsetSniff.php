...
class NewNegativeStringOffsetSniff extends AbstractFunctionCallParameterSniff
{
     ...
     */
    protected $targetFunctions = array('file_get_contents' => array(4 => 'offset'), 'grapheme_extract' => array(4 => 'start'), 'grapheme_stripos' => array(3 => 'offset'), 'grapheme_strpos' => array(3 => 'offset'), 'iconv_strpos' => array(3 => 'offset'), 'mb_ereg_search_setpos' => array(1 => 'position'), 'mb_strimwidth' => array(2 => 'start', 3 => 'width'), 'mb_stripos' => array(3 => 'offset'), 'mb_strpos' => array(3 => 'offset'), 'stripos' => array(3 => 'offset'), 'strpos' => array(3 => 'offset'), 'substr_count' => array(3 => 'offset', 4 => 'length'));
    /**
    ...
    public function processParameters(File $phpcsFile, $stackPtr, $functionName, $parameters)
    {
        ...
        foreach ($this->targetFunctions[$functionLC] as $pos => $name) {
            ...
            $phpcsFile->addError('Negative string offsets were not supported for the $%s parameter in %s() in PHP 7.0 or lower. Found %s', $targetParam['start'], 'Found', array($name, $functionName, $targetParam['raw']));
        }
    }
}
