...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\ParameterValues\RemovedPCREModifiersSniff;
...
class NewPCREModifiersSniff extends RemovedPCREModifiersSniff
{
     ...
     * @var array
     */
    protected $targetFunctions = array('preg_filter' => \true, 'preg_grep' => \true, 'preg_match_all' => \true, 'preg_match' => \true, 'preg_replace_callback_array' => \true, 'preg_replace_callback' => \true, 'preg_replace' => \true, 'preg_split' => \true);
    /**
     ...
     * @var array
     */
    protected $newModifiers = array('J' => array('7.1' => \false, '7.2' => \true));
    /**
    ...
    protected function examineModifiers(File $phpcsFile, $stackPtr, $functionName, $modifiers)
    {
        ...
        foreach ($this->newModifiers as $modifier => $versionArray) {
            ...
            foreach ($versionArray as $version => $present) {
                if ($notInVersion === '' && $present === \false && $this->supportsBelow($version) === \true) {
            ...
            $data = array($modifier, $notInVersion);
