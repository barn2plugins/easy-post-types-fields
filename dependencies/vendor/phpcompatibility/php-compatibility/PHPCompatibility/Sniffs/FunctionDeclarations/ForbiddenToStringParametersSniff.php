...
class ForbiddenToStringParametersSniff extends Sniff
{
     ...
     * @var array
     */
    protected $ooScopeTokens = array('T_CLASS' => \true, 'T_INTERFACE' => \true, 'T_TRAIT' => \true, 'T_ANON_CLASS' => \true);
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $phpcsFile->addError('The __toString() magic method can no longer accept arguments since PHP 5.3', $stackPtr, 'Declared');
    }
}
