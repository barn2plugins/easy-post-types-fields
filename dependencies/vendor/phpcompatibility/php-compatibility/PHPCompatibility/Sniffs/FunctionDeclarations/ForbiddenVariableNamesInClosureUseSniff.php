...
class ForbiddenVariableNamesInClosureUseSniff extends Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $previousNonEmpty = $phpcsFile->findPrevious(Tokens::$emptyTokens, $stackPtr - 1, null, \true, null, \true);
        if ($previousNonEmpty === \false || $tokens[$previousNonEmpty]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSE_PARENTHESIS || isset($tokens[$previousNonEmpty]['parenthesis_opener']) === \false) {
            return;
        }
        ...
        $closurePtr = $phpcsFile->findPrevious(Tokens::$emptyTokens, $tokens[$previousNonEmpty]['parenthesis_opener'] - 1, null, \true);
        if ($closurePtr === \false || $tokens[$closurePtr]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSURE) {
            return;
        }
