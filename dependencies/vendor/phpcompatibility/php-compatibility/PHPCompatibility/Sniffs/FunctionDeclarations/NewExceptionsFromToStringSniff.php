...
class NewExceptionsFromToStringSniff extends Sniff
{
     ...
     * @var array
     */
    protected $ooScopeTokens = array('T_CLASS' => \true, 'T_TRAIT' => \true, 'T_ANON_CLASS' => \true);
    /**
     ...
     * @var array
     */
    private $docblockIgnoreTokens = array(\T_WHITESPACE => \T_WHITESPACE);
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
         ...
         */
        $commentEnd = $phpcsFile->findPrevious($this->docblockIgnoreTokens, $stackPtr - 1, null, \true);
        if ($commentEnd === \false || $tokens[$commentEnd]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOC_COMMENT_CLOSE_TAG) {
            return;
        }
