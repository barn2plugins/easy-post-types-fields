...
class NewParamTypeDeclarationsSniff extends AbstractNewFeatureSniff
{
     ...
     */
    protected $newTypes = array('array' => array('5.0' => \false, '5.1' => \true), 'self' => array('5.1' => \false, '5.2' => \true), 'parent' => array('5.1' => \false, '5.2' => \true), 'callable' => array('5.3' => \false, '5.4' => \true), 'int' => array('5.6' => \false, '7.0' => \true), 'float' => array('5.6' => \false, '7.0' => \true), 'bool' => array('5.6' => \false, '7.0' => \true), 'string' => array('5.6' => \false, '7.0' => \true), 'iterable' => array('7.0' => \false, '7.1' => \true), 'object' => array('7.1' => \false, '7.2' => \true));
    /**
     * Invalid types
     *
     ...
     */
    protected $invalidTypes = array('static' => 'self', 'boolean' => 'bool', 'integer' => 'int');
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($paramNames as $param) {
            ...
            if ($supportsPHP4 === \true) {
                $phpcsFile->addError('Type declarations were not present in PHP 4.4 or earlier.', $param['token'], 'TypeHintFound');
            } elseif (isset($this->newTypes[$typeHint])) {
                $itemInfo = array('name' => $typeHint);
                ...
                // will be thrown.
                if (($typeHint === 'self' || $typeHint === 'parent') && $this->inClassScope($phpcsFile, $stackPtr, \false) === \false && $this->supportsAbove('5.2') !== \false) {
                    $phpcsFile->addError("'%s' type cannot be used outside of class scope", $param['token'], \ucfirst($typeHint) . 'OutsideClassScopeFound', array($typeHint));
                }
            } elseif (isset($this->invalidTypes[$typeHint])) {
                $error = "'%s' is not a valid type declaration. Did you mean %s ?";
                $data = array($typeHint, $this->invalidTypes[$typeHint]);
