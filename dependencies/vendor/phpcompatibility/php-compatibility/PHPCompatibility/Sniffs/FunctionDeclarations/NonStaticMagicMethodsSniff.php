...
class NonStaticMagicMethodsSniff extends Sniff
{
     ...
     * @var array(string)
     */
    protected $magicMethods = array('__construct' => array('static' => \false), '__destruct' => array('visibility' => 'public', 'static' => \false), '__clone' => array('static' => \false), '__get' => array('visibility' => 'public', 'static' => \false), '__set' => array('visibility' => 'public', 'static' => \false), '__isset' => array('visibility' => 'public', 'static' => \false), '__unset' => array('visibility' => 'public', 'static' => \false), '__call' => array('visibility' => 'public', 'static' => \false), '__callstatic' => array('visibility' => 'public', 'static' => \true), '__sleep' => array('visibility' => 'public'), '__tostring' => array('visibility' => 'public'), '__set_state' => array('visibility' => 'public', 'static' => \true), '__debuginfo' => array('visibility' => 'public', 'static' => \false), '__invoke' => array('visibility' => 'public', 'static' => \false), '__serialize' => array('visibility' => 'public', 'static' => \false), '__unserialize' => array('visibility' => 'public', 'static' => \false));
    /**
    ...
    {
        $targets = array(\T_CLASS, \T_INTERFACE, \T_TRAIT);
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        while (($functionToken = $phpcsFile->findNext(\T_FUNCTION, $functionPtr, $classScopeCloser)) !== \false) {
            ...
            if (isset($this->magicMethods[$methodNameLc]['visibility']) && $this->magicMethods[$methodNameLc]['visibility'] !== $methodProperties['scope']) {
                ...
                $data = array($methodName, $this->magicMethods[$methodNameLc]['visibility'], $methodProperties['scope']);
            ...
            if (isset($this->magicMethods[$methodNameLc]['static']) && $this->magicMethods[$methodNameLc]['static'] !== $methodProperties['is_static']) {
                ...
                if ($this->magicMethods[$methodNameLc]['static'] === \true) {
