...
class RemovedNamespacedAssertSniff extends Sniff
{
     ...
     * @var array
     */
    private $scopes = array(\T_CLASS, \T_INTERFACE, \T_TRAIT, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSURE);
    /**
    ...
    public function register()
    {
        ...
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ANON_CLASS')) {
            $this->scopes[] = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_ANON_CLASS;
        }
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($phpcsFile->hasCondition($stackPtr, $this->scopes) === \true) {
            return;
        }
