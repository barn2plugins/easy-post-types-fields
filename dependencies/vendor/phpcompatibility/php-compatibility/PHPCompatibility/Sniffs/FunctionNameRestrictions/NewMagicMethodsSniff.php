...
class NewMagicMethodsSniff extends AbstractNewFeatureSniff
{
    ...
    protected $newMagicMethods = array(
        '__construct' => array('4.4' => \false, '5.0' => \true),
        '__destruct' => array('4.4' => \false, '5.0' => \true),
        '__get' => array('4.4' => \false, '5.0' => \true),
        '__isset' => array('5.0' => \false, '5.1' => \true),
        '__unset' => array('5.0' => \false, '5.1' => \true),
        '__set_state' => array('5.0' => \false, '5.1' => \true),
        '__callstatic' => array('5.2' => \false, '5.3' => \true),
        '__invoke' => array('5.2' => \false, '5.3' => \true),
        '__debuginfo' => array('5.5' => \false, '5.6' => \true),
        // Special case - only became properly magical in 5.2.0,
        // before that it was only called for echo and print.
        '__tostring' => array('5.1' => \false, '5.2' => \true, 'message' => 'The method %s() was not truly magical in PHP version %s and earlier. The associated magic functionality will only be called when directly combined with echo or print.'),
        '__serialize' => array('7.3' => \false, '7.4' => \true),
        '__unserialize' => array('7.3' => \false, '7.4' => \true),
    );
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $itemInfo = array('name' => $functionName, 'nameLc' => $functionNameLc);
