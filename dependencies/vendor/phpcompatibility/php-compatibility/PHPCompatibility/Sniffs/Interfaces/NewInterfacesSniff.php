 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\Interfaces;
...
class NewInterfacesSniff extends AbstractNewFeatureSniff
{
     ...
     */
    protected $newInterfaces = array('Traversable' => array('4.4' => \false, '5.0' => \true), 'Reflector' => array('4.4' => \false, '5.0' => \true), 'Countable' => array('5.0' => \false, '5.1' => \true), 'OuterIterator' => array('5.0' => \false, '5.1' => \true), 'RecursiveIterator' => array('5.0' => \false, '5.1' => \true), 'SeekableIterator' => array('5.0' => \false, '5.1' => \true), 'Serializable' => array('5.0' => \false, '5.1' => \true), 'SplObserver' => array('5.0' => \false, '5.1' => \true), 'SplSubject' => array('5.0' => \false, '5.1' => \true), 'JsonSerializable' => array('5.3' => \false, '5.4' => \true), 'SessionHandlerInterface' => array('5.3' => \false, '5.4' => \true), 'DateTimeInterface' => array('5.4' => \false, '5.5' => \true), 'SessionIdInterface' => array('5.5.0' => \false, '5.5.1' => \true), 'Throwable' => array('5.6' => \false, '7.0' => \true), 'SessionUpdateTimestampHandlerInterface' => array('5.6' => \false, '7.0' => \true));
    /**
     ...
     */
    protected $unsupportedMethods = array('Serializable' => array('__sleep' => 'https://www.php.net/serializable', '__wakeup' => 'https://www.php.net/serializable'));
    /**
    ...
    public function register()
    {
        ...
        $targets = array(\T_CLASS, \T_FUNCTION, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSURE);
    ...
    private function processClassToken(File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($interfaces as $interface) {
            ...
            if (isset($this->newInterfaces[$interfaceLc]) === \true) {
                $itemInfo = array('name' => $interface, 'nameLc' => $interfaceLc);
                $this->handleFeature($phpcsFile, $stackPtr, $itemInfo);
            }
            if ($checkMethods === \true && isset($this->unsupportedMethods[$interfaceLc]) === \true) {
                $nextFunc = $stackPtr;
                while (($nextFunc = $phpcsFile->findNext(\T_FUNCTION, $nextFunc + 1, $scopeCloser)) !== \false) {
                    ...
                    if (isset($this->unsupportedMethods[$interfaceLc][$funcNameLc]) === \true) {
                        ...
                        $data = array($interface, $funcName, $this->unsupportedMethods[$interfaceLc][$funcNameLc]);
    ...
    private function processFunctionToken(File $phpcsFile, $stackPtr)
    {
        ...
        foreach ($typeHints as $hint) {
            ...
            if (isset($this->newInterfaces[$typeHintLc]) === \true) {
