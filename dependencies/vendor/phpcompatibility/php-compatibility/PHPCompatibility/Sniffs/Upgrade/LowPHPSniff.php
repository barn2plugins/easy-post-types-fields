...
class LowPHPSniff extends Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (\version_compare($phpVersion, self::MIN_SUPPORTED_VERSION, '<')) {
            ...
            $replacements = array(self::MIN_SUPPORTED_VERSION, $phpVersion, self::MIN_RECOMMENDED_VERSION, $errorCode);
        } else {
            $isError = \false;
            ...
            $replacements = array(self::MIN_RECOMMENDED_VERSION, $phpVersion, self::MIN_RECOMMENDED_VERSION, $errorCode);
        }
        /*
