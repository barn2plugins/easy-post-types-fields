 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\Upgrade;
...
class LowPHPCSSniff extends Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (\version_compare($phpcsVersion, self::MIN_SUPPORTED_VERSION, '<')) {
            ...
            $replacements = array(self::MIN_SUPPORTED_VERSION, $phpcsVersion, self::MIN_RECOMMENDED_VERSION, $errorCode);
        } else {
            $isError = \false;
            ...
            $replacements = array(self::MIN_RECOMMENDED_VERSION, $phpcsVersion, self::MIN_RECOMMENDED_VERSION, $errorCode);
        }
        /*
        ...
        $messageWidth = $reportWidth - 15;
        // 15 is length of " # | WARNING | ".
