...
class RemovedFunctionParametersSniff extends AbstractRemovedFeatureSniff
{
     ...
     * @var array
     */
    protected $removedFunctionParameters = array('curl_version' => array(0 => array('name' => 'age', '7.4' => \false, 'callback' => 'curlVersionInvalidValue')), 'define' => array(2 => array('name' => 'case_insensitive', '7.3' => \false)), 'gmmktime' => array(6 => array('name' => 'is_dst', '5.1' => \false, '7.0' => \true)), 'ldap_first_attribute' => array(2 => array('name' => 'ber_identifier', '5.2.4' => \true)), 'ldap_next_attribute' => array(2 => array('name' => 'ber_identifier', '5.2.4' => \true)), 'mktime' => array(6 => array('name' => 'is_dst', '5.1' => \false, '7.0' => \true)));
    /**
    ...
    protected function curlVersionInvalidValue(File $phpcsFile, array $parameter)
    {
        ...
        if ($raw !== 'CURLVERSION_NOW' && $raw !== (string) \CURLVERSION_NOW) {
            return \true;
        }
        return \false;
    }
