...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\InitialValue\NewConstantScalarExpressionsSniff;
...
class NewHeredocSniff extends NewConstantScalarExpressionsSniff
{
     ...
     * @var array
     */
    protected $errorPhrases = array('const' => 'constants', 'property' => 'class properties', 'staticvar' => 'static variables', 'default' => 'default parameter values');
    /**
    ...
    {
        return $this->supportsBelow('5.2') !== \true;
    }
    /**
    ...
    protected function isValidAssignment(File $phpcsFile, $stackPtr, $end)
    {
        ...
        return $phpcsFile->findNext(\T_START_HEREDOC, $next + 1, $end, \false, null, \true) === \false;
    }
}
