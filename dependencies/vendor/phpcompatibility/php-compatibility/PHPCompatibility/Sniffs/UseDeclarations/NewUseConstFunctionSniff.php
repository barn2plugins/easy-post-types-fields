...
class NewUseConstFunctionSniff extends Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $functionOrConstName = $phpcsFile->findNext(Tokens::$emptyTokens, $nextNonEmpty + 1, null, \true);
        if ($functionOrConstName === \false || ($tokens[$functionOrConstName]['content'] === 'as' || $tokens[$functionOrConstName]['code'] === \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_COMMA)) {
        ...
        $phpcsFile->addError('Importing functions and constants through a "use" statement is not supported in PHP 5.5 or lower.', $nextNonEmpty, 'Found');
    }
}
