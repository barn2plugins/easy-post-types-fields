 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\MethodUse;
...
class ForbiddenToStringParametersSniff extends Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $openParens = $phpcsFile->findNext(Tokens::$emptyTokens, $nextNonEmpty + 1, null, \true);
        if ($openParens === \false || $tokens[$openParens]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS) {
            // Not a method call.
            return;
        }
        $closeParens = $phpcsFile->findNext(Tokens::$emptyTokens, $openParens + 1, null, \true);
        if ($closeParens === \false || $tokens[$closeParens]['code'] === \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSE_PARENTHESIS) {
            // Not a method call.
            return;
        }
