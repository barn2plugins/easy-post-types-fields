...
class NewDirectCallsToCloneSniff extends Sniff
{
     ...
     * @var array
     */
    protected $classInternal = array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_PARENT => \true, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_SELF => \true, \T_STATIC => \true);
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($nextNextNonEmpty === \false || $tokens[$nextNextNonEmpty]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS) {
            // Not a method call.
            return;
        }
