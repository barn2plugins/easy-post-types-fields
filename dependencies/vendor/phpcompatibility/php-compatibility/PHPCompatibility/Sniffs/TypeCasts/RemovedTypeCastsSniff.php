...
class RemovedTypeCastsSniff extends AbstractRemovedFeatureSniff
{
     ...
     */
    protected $deprecatedTypeCasts = array('T_UNSET_CAST' => array('7.2' => \false, 'alternative' => 'unset()', 'description' => 'unset'), 'T_DOUBLE_CAST' => array('7.4' => \false, 'alternative' => '(float)', 'description' => 'real'));
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $itemInfo = array('name' => $tokenType, 'description' => $this->deprecatedTypeCasts[$tokenType]['description']);
