 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\TypeCasts;
...
class NewTypeCastsSniff extends AbstractNewFeatureSniff
{
     ...
     */
    protected $newTypeCasts = array('T_UNSET_CAST' => array('4.4' => \false, '5.0' => \true, 'description' => 'The unset cast'), 'T_BINARY_CAST' => array('5.2.0' => \false, '5.2.1' => \true, 'description' => 'The binary cast'));
    /**
    ...
    public function register()
    {
         ...
         */
        if (\version_compare(PHPCSHelper::getVersion(), '3.4.0', '<') === \true) {
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($this->newTypeCasts[$tokenType]) === \false) {
            ...
            switch ($tokenType) {
                ...
                case 'T_CONSTANT_ENCAPSED_STRING':
                    if (\strpos($tokenContent, 'b"') === 0 && \substr($tokenContent, -1) === '"' || \strpos($tokenContent, "b'") === 0 && \substr($tokenContent, -1) === "'") {
                        $tokenType = 'T_BINARY_CAST';
                    } else {
                        return;
                    }
        ...
        $itemInfo = array('name' => $tokenType, 'content' => $tokens[$stackPtr]['content']);
