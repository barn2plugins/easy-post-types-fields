...
class NewShortListSniff extends Sniff
{
    ...
    {
        return array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_SHORT_ARRAY);
    }
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $phpcsFile->addError('The shorthand list syntax "[]" to destructure arrays is not available in PHP 7.0 or earlier.', $stackPtr, 'Found');
        return $closer + 1;
    }
}
