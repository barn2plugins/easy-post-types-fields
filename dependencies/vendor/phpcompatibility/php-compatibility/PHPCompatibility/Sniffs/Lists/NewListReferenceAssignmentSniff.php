...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\Lists\NewKeyedListSniff;
...
class NewListReferenceAssignmentSniff extends NewKeyedListSniff
{
     ...
     * @var array
     */
    protected $targetsInList = array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BITWISE_AND => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BITWISE_AND);
    /**
    ...
    protected function examineList(File $phpcsFile, $opener, $closer)
    {
        ...
        while (($start = $this->hasTargetInList($phpcsFile, $start, $closer)) !== \false) {
            $phpcsFile->addError('Reference assignments within list constructs are not supported in PHP 7.2 or earlier.', $start, 'Found');
        }
    }
}
