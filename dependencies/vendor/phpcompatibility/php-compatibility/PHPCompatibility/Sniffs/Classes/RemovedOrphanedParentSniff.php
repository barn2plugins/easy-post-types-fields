...
class RemovedOrphanedParentSniff extends Sniff
{
     ...
     * @var array
     */
    public $classScopeTokens = array('T_CLASS' => \true, 'T_ANON_CLASS' => \true);
    /**
    ...
    {
        return array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_PARENT);
    }
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        $phpcsFile->addError('Using "parent" inside a class without parent is deprecated since PHP 7.4', $stackPtr, 'Deprecated');
    }
}
