...
class ForbiddenAbstractPrivateMethodsSniff extends Sniff
{
     ...
     * @var array
     */
    public $ooScopeTokens = array('T_CLASS' => \true, 'T_TRAIT' => \true, 'T_ANON_CLASS' => \true);
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($properties['scope'] !== 'private' || $properties['is_abstract'] !== \true) {
            return;
        }
        $phpcsFile->addError('Abstract methods cannot be declared as private since PHP 5.1', $stackPtr, 'Found');
    }
}
