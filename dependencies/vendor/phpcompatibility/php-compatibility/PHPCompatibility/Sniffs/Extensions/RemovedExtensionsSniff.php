 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPCompatibility\Sniffs\Extensions;
...
class RemovedExtensionsSniff extends AbstractRemovedFeatureSniff
{
    ...
    protected $removedExtensions = array(
        'activescript' => array('5.1' => \true, 'alternative' => 'pecl/activescript'),
        'cpdf' => array('5.1' => \true, 'alternative' => 'pecl/pdflib'),
        'dbase' => array('5.3' => \true, 'alternative' => null),
        'dbx' => array('5.1' => \true, 'alternative' => 'pecl/dbx'),
        'dio' => array('5.1' => \true, 'alternative' => 'pecl/dio'),
        'ereg' => array('5.3' => \false, '7.0' => \true, 'alternative' => 'pcre'),
        'fam' => array('5.1' => \true, 'alternative' => null),
        'fbsql' => array('5.3' => \true, 'alternative' => null),
        'fdf' => array('5.3' => \true, 'alternative' => 'pecl/fdf'),
        'filepro' => array('5.2' => \true, 'alternative' => null),
        'hw_api' => array('5.2' => \true, 'alternative' => null),
        'ibase' => array('7.4' => \true, 'alternative' => 'pecl/ibase'),
        'ingres' => array('5.1' => \true, 'alternative' => 'pecl/ingres'),
        'ircg' => array('5.1' => \true, 'alternative' => null),
        'mcrypt' => array('7.1' => \false, '7.2' => \true, 'alternative' => 'openssl (preferred) or pecl/mcrypt once available'),
        'mcve' => array('5.1' => \true, 'alternative' => 'pecl/mcve'),
        'ming' => array('5.3' => \true, 'alternative' => 'pecl/ming'),
        'mnogosearch' => array('5.1' => \true, 'alternative' => null),
        'msql' => array('5.3' => \true, 'alternative' => null),
        'mssql' => array('7.0' => \true, 'alternative' => null),
        'mysql_' => array('5.5' => \false, '7.0' => \true, 'alternative' => 'mysqli'),
        'ncurses' => array('5.3' => \true, 'alternative' => 'pecl/ncurses'),
        'oracle' => array('5.1' => \true, 'alternative' => 'oci8 or pdo_oci'),
        'ovrimos' => array('5.1' => \true, 'alternative' => null),
        'pfpro_' => array('5.1' => \true, 'alternative' => null),
        'recode' => array('7.4' => \true, 'alternative' => 'iconv or mbstring'),
        'sqlite' => array('5.4' => \true, 'alternative' => null),
        // Has to be before `sybase` as otherwise it will never match.
        'sybase_ct' => array('7.0' => \true, 'alternative' => null),
        'sybase' => array('5.3' => \true, 'alternative' => 'sybase_ct'),
        'w32api' => array('5.1' => \true, 'alternative' => 'pecl/ffi'),
        'wddx' => array('7.4' => \true, 'alternative' => 'pecl/wddx'),
        'yp' => array('5.1' => \true, 'alternative' => null),
    );
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$openBracket]['code'] !== \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS) {
            // Not a function call.
            return;
        }
        ...
        $search[] = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BITWISE_AND;
    ...
    protected function isWhiteListed($content)
    {
        ...
        if (\is_string($this->functionWhitelist) === \true) {
        ...
        if (\is_array($this->functionWhitelist) === \true) {
            $this->functionWhitelist = \array_map('strtolower', $this->functionWhitelist);
            return \in_array($content, $this->functionWhitelist, \true);
        }
        return \false;
    }
    /**
