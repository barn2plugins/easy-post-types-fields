...
abstract class AbstractFunctionCallParameterSniff extends Sniff
{
     ...
     * @var array
     */
    private $ignoreTokens = array(\T_DOUBLE_COLON => \true, \T_OBJECT_OPERATOR => \true, \T_FUNCTION => \true, \T_NEW => \true, \T_CONST => \true, \T_USE => \true);
    /**
     ...
     * @return bool
     */
    protected abstract function bowOutEarly();
    /**
     ...
     *                  normal file processing.
     */
    public abstract function processParameters(File $phpcsFile, $stackPtr, $functionName, $parameters);
    /**
