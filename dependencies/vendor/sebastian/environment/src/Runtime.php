 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Environment;
...
final class Runtime
{
    ...
    {
        return defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\HHVM_VERSION');
    }
    /**
