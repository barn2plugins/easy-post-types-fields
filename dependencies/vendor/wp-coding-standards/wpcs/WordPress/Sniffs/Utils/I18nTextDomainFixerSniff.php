 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\WordPressCS\WordPress\Sniffs\Utils;
...
class I18nTextDomainFixerSniff extends AbstractFunctionParameterSniff
{
     ...
     */
    private $theme_headers = array('Theme Name' => \true, 'Theme URI' => \false, 'Author' => \true, 'Author URI' => \false, 'Description' => \true, 'Version' => \true, 'License' => \true, 'License URI' => \true, 'Tags' => \false, 'Text Domain' => \true, 'Domain Path' => \false);
    /**
     ...
     *            required (true) or optional (false) header.
     */
    private $plugin_headers = array('Plugin Name' => \true, 'Plugin URI' => \false, 'Description' => \false, 'Version' => \false, 'Author' => \false, 'Author URI' => \false, 'License' => \false, 'License URI' => \false, 'Text Domain' => \false, 'Domain Path' => \false, 'Network' => \false);
    /**
    ...
    public function register()
    {
        ...
        $targets[] = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOC_COMMENT_OPEN_TAG;
        $targets[] = \T_COMMENT;
        return $targets;
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        if (isset($this->tab_width) === \false) {
            if (isset($this->phpcsFile->config->tabWidth) === \false || 0 === $this->phpcsFile->config->tabWidth) {
        ...
        if (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOC_COMMENT_OPEN_TAG === $this->tokens[$stackPtr]['code'] || \T_COMMENT === $this->tokens[$stackPtr]['code']) {
    ...
    public function process_no_parameters($stackPtr, $group_name, $matched_content)
    {
        ...
        if (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS !== $this->tokens[$opener]['code'] || isset($this->tokens[$opener]['parenthesis_closer']) === \false) {
    ...
    {
        if (\true === $this->header_found && !\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS')) {
            return;
        }
        ...
        if ('CSS' === $this->phpcsFile->tokenizerType) {
            if ('style.css' !== $file_name && !\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHP_CODESNIFFER_IN_TESTS')) {
        ...
        if (\T_COMMENT === $this->tokens[$stackPtr]['code']) {
            ...
            $current = $stackPtr;
            while (($current = $this->phpcsFile->findNext(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOC_COMMENT_STRING, $current + 1, $closer)) !== \false) {
                $comment_details = $this->examine_comment_line($current, $regex, $headers, $comment_details);
        ...
        if (\true === $comment_details['required_header_found'] && $comment_details['headers_found'] >= 3) {
            ...
            if (\false !== $text_domain_ptr) {
                ...
                if (\true === $fix) {
                    ...
                    if (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOC_COMMENT_OPEN_TAG === $this->tokens[$stackPtr]['code']) {
