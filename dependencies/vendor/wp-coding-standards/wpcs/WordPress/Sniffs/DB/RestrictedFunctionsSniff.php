...
class RestrictedFunctionsSniff extends AbstractFunctionRestrictionsSniff
{
    ...
    {
        return array('mysql' => array('type' => 'error', 'message' => 'Accessing the database directly should be avoided. Please use the $wpdb object and associated functions instead. Found: %s.', 'functions' => array('mysql_*', 'mysqli_*', 'mysqlnd_ms_*', 'mysqlnd_qc_*', 'mysqlnd_uh_*', 'mysqlnd_memcache_*', 'maxdb_*'), 'whitelist' => array('mysql_to_rfc3339' => \true)));
    }
}
