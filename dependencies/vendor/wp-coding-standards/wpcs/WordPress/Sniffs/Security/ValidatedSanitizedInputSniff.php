...
class ValidatedSanitizedInputSniff extends Sniff
{
     ...
     * @var array
     */
    protected $addedCustomFunctions = array('sanitize' => array(), 'unslashsanitize' => array());
    /**
    ...
    {
        return array(\T_VARIABLE, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOUBLE_QUOTED_STRING, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_HEREDOC);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        if (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_DOUBLE_QUOTED_STRING === $this->tokens[$stackPtr]['code'] || \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_HEREDOC === $this->tokens[$stackPtr]['code']) {
        ...
        for ($i = $stackPtr + 1; $i < $this->phpcsFile->numTokens; $i++) {
            ...
            if (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_SQUARE_BRACKET === $this->tokens[$i]['code'] && isset($this->tokens[$i]['bracket_closer'])) {
