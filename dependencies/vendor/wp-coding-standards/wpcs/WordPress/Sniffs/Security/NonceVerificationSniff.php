...
class NonceVerificationSniff extends Sniff
{
     ...
     * @var array
     */
    protected $superglobals = array('$_POST' => \true, '$_FILE' => \true, '$_GET' => \false, '$_REQUEST' => \false);
    /**
     ...
     * @var array
     */
    protected $addedCustomFunctions = array('nonce' => array(), 'sanitize' => array(), 'unslashsanitize' => array());
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        $this->addMessage('Processing form data without nonce verification.', $stackPtr, $this->superglobals[$instance['content']], $error_code);
    }
    /**
    ...
    protected function mergeFunctionLists()
    {
        if ($this->customNonceVerificationFunctions !== $this->addedCustomFunctions['nonce']) {
            $this->nonceVerificationFunctions = $this->merge_custom_array($this->customNonceVerificationFunctions, $this->nonceVerificationFunctions);
