...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\WordPressCS\WordPress\AbstractArrayAssignmentRestrictionsSniff;
/**
...
class PostsPerPageSniff extends AbstractArrayAssignmentRestrictionsSniff
{
    ...
    {
        return array('posts_per_page' => array('type' => 'warning', 'keys' => array('posts_per_page', 'numberposts')));
    }
    /**
