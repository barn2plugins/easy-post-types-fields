...
class DeprecatedParameterValuesSniff extends AbstractFunctionParameterSniff
{
     ...
     *     );
     */
    protected $target_functions = array('add_settings_field' => array(4 => array('misc' => array('alt' => 'another settings group', 'version' => '3.0.0'), 'privacy' => array('alt' => 'another settings group', 'version' => '3.5.0'))), 'add_settings_section' => array(4 => array('misc' => array('alt' => 'another settings group', 'version' => '3.0.0'), 'privacy' => array('alt' => 'another settings group', 'version' => '3.5.0'))), 'bloginfo' => array(1 => array('home' => array('alt' => 'the "url" argument', 'version' => '2.2.0'), 'siteurl' => array('alt' => 'the "url" argument', 'version' => '2.2.0'), 'text_direction' => array('alt' => 'is_rtl()', 'version' => '2.2.0'))), 'get_bloginfo' => array(1 => array('home' => array('alt' => 'the "url" argument', 'version' => '2.2.0'), 'siteurl' => array('alt' => 'the "url" argument', 'version' => '2.2.0'), 'text_direction' => array('alt' => 'is_rtl()', 'version' => '2.2.0'))), 'register_setting' => array(1 => array('misc' => array('alt' => 'another settings group', 'version' => '3.0.0'), 'privacy' => array('alt' => 'another settings group', 'version' => '3.5.0'))), 'unregister_setting' => array(1 => array('misc' => array('alt' => 'another settings group', 'version' => '3.0.0'), 'privacy' => array('alt' => 'another settings group', 'version' => '3.5.0'))));
    /**
    ...
    protected function process_parameter($matched_content, $parameter, $parameter_args)
    {
        ...
        $this->addMessage($message, $parameter_position, $is_error, $this->string_to_errorcode('Found'), $data);
    }
}
