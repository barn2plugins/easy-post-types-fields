...
class EnqueuedResourceParametersSniff extends AbstractFunctionParameterSniff
{
     ...
     * @var array
     */
    private $false_tokens = array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_FALSE => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_FALSE);
    /**
     ...
     * @var array
     */
    private $safe_tokens = array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_NULL => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_NULL, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_FALSE => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_FALSE, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_TRUE => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_TRUE, \T_LNUMBER => \T_LNUMBER, \T_DNUMBER => \T_DNUMBER, \T_CONSTANT_ENCAPSED_STRING => \T_CONSTANT_ENCAPSED_STRING, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_START_NOWDOC => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_START_NOWDOC, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_NOWDOC => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_NOWDOC, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_END_NOWDOC => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_END_NOWDOC, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSE_PARENTHESIS => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_CLOSE_PARENTHESIS, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_STRING_CONCAT => \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_STRING_CONCAT);
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        if (!isset($parameters[4]) || 'null' === $parameters[4]['raw']) {
            ...
            $this->phpcsFile->addError('Resource version not set in call to %s(). This means new versions of the %s will not always be loaded due to browser caching.', $stackPtr, 'MissingVersion', array($matched_content, $type));
        } else {
            // The version argument should have a non-false value.
            if ($this->is_falsy($parameters[4]['start'], $parameters[4]['end'])) {
                $this->phpcsFile->addError('Version parameter is not explicitly set or has been set to an equivalent of "false" for %s; ' . 'This means that the WordPress core version will be used which is not recommended for plugin or theme development.', $stackPtr, 'NoExplicitVersion', array($matched_content));
            }
        }
        /*
         * In footer Check
