...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\WordPressCS\WordPress\AbstractClassRestrictionsSniff;
/**
...
class DeprecatedClassesSniff extends AbstractClassRestrictionsSniff
{
    ...
    public function process_matched_token($stackPtr, $group_name, $matched_content)
    {
        ...
        $this->addMessage($message, $stackPtr, \version_compare($this->deprecated_classes[$class_name]['version'], $this->minimum_supported_version, '<'), $this->string_to_errorcode($class_name . 'Found'), $data);
    }
}
