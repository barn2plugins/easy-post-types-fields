...
class MultipleStatementAlignmentSniff extends Sniff
{
    ...
    protected function process_multi_line_array($stackPtr, $items, $opener, $closer)
    {
        ...
        foreach ($items as $key => $item) {
            ...
            $double_arrow = $this->phpcsFile->findNext(\T_DOUBLE_ARROW, $item['start'], $item['end'] + 1);
            ...
            $has_array_opener = $this->phpcsFile->findNext($this->register(), $item['start'], $double_arrow);
