...
class StrictInArraySniff extends AbstractFunctionParameterSniff
{
     ...
     */
    protected $target_functions = array('in_array' => \true, 'array_search' => \true, 'array_keys' => \false);
    /**
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        if (\false === isset($parameters[3]) || 'true' !== \strtolower($parameters[3]['raw'])) {
            ...
            $this->phpcsFile->addWarning('Not using strict comparison for %s; supply true for third argument.', isset($parameters[3]['start']) ? $parameters[3]['start'] : $parameters[1]['start'], $errorcode, array($matched_content));
            return;
        }
    }
}
