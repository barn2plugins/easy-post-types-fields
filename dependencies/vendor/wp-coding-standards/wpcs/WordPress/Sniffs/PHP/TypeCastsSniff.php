...
class TypeCastsSniff extends Sniff
{
    ...
    {
        return array(\T_DOUBLE_CAST, \T_UNSET_CAST, \T_STRING_CAST, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BINARY_CAST);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        switch ($token_code) {
            case \T_DOUBLE_CAST:
                ...
                break;
            case \T_UNSET_CAST:
                $this->phpcsFile->addWarning('Using the "(unset)" cast is strongly discouraged. Use the "unset()" language construct or assign "null" as the value to the variable instead.', $stackPtr, 'UnsetFound');
                break;
            case \T_STRING_CAST:
            case \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BINARY_CAST:
