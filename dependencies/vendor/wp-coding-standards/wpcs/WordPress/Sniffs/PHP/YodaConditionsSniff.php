...
class YodaConditionsSniff extends Sniff
{
    ...
    public function register()
    {
        ...
        $starters[\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_INLINE_THEN] = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_INLINE_THEN;
    ...
    public function process_token($stackPtr)
    {
        ...
        if (\in_array($this->tokens[$next_non_empty]['code'], array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_SELF, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_PARENT, \T_STATIC), \true)) {
