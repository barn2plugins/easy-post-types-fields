...
class NoSilencedErrorsSniff extends Sniff
{
     ...
     * @var bool
     */
    public $use_default_whitelist = \true;
    /**
    ...
    public function register()
    {
        ...
        $this->empty_tokens[\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BITWISE_AND] = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_BITWISE_AND;
        return array(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_ASPERAND);
    }
    /**
    ...
    public function process_token($stackPtr)
    {
        ...
        if (\false !== $next_non_empty && \T_STRING === $this->tokens[$next_non_empty]['code']) {
            ...
            if (\false !== $has_parenthesis && \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_OPEN_PARENTHESIS === $this->tokens[$has_parenthesis]['code']) {
                $function_name = \strtolower($this->tokens[$next_non_empty]['content']);
                if (\true === $this->use_default_whitelist && isset($this->function_whitelist[$function_name]) === \true || !empty($this->custom_whitelist) && \in_array($function_name, $this->custom_whitelist, \true) === \true) {
        ...
        $end_of_statement = $this->phpcsFile->findEndOfStatement($stackPtr, \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_COMMA);
