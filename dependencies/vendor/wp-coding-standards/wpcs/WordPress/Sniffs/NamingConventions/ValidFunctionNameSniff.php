...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHP_CodeSniffer\Standards\PEAR\Sniffs\NamingConventions\ValidFunctionNameSniff as PHPCS_PEAR_ValidFunctionNameSniff;
...
class ValidFunctionNameSniff extends PHPCS_PEAR_ValidFunctionNameSniff
{
    ...
    {
        if (Sniff::is_function_deprecated($phpcsFile, $stackPtr) === \true) {
            /*
        ...
        if ($functionNameLc !== $functionName) {
            ...
            $errorData = array($functionName, Sniff::get_snake_case_name_suggestion($functionName));
    ...
    protected function processTokenWithinScope(File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($methodNameLc !== $methodName) {
            ...
            $errorData = array($methodName, $className, Sniff::get_snake_case_name_suggestion($methodName));
