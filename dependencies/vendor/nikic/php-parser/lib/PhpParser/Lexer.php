...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Parser\Tokens;
class Lexer
{
    protected $code;
    protected $tokens;
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_ONUMBER')) {
            $tokenMap[\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
