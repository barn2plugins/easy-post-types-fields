...
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PhpParser\Lexer\TokenEmulator\TokenEmulator;
