...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestFailure;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Color;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Printer;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Environment\Console;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Timer\ResourceUsageFormatter;
...
class DefaultResultPrinter extends Printer implements ResultPrinter
{
    ...
    {
        if ($this->debug) {
            $this->write(sprintf("Test '%s' started\n", \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Test::describeAsString($test)));
        }
    }
    /**
     * A test ended.
