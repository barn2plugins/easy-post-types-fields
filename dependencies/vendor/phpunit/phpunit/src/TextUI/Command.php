...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Extension\PharLoader;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\CliArguments\Builder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\CliArguments\Configuration;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\CliArguments\Exception as ArgumentsException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\CliArguments\Mapper;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\FilterMapper;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Generator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Loader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Migrator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\PhpHandler;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\FileLoader;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TextTestListRenderer;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\SchemaDetector;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\XmlTestListRenderer;
use ReflectionClass;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Filter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\StaticAnalysis\CacheWarmer;
...
class Command
{
    ...
    protected function handleBootstrap(string $filename) : void
    {
        try {
            ...
            if ($t instanceof \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Exception) {
