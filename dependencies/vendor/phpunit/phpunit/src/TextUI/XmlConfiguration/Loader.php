 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\DefaultResultPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\CodeCoverage;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Filter\Directory as FilterDirectory;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Filter\DirectoryCollection as FilterDirectoryCollection;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Clover;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Cobertura;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Crap4j;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Html as CodeCoverageHtml;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Php as CodeCoveragePhp;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Text as CodeCoverageText;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Xml as CodeCoverageXml;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\Junit;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\Logging;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\TeamCity;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Html as TestDoxHtml;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Text as TestDoxText;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Xml as TestDoxXml;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Logging\Text;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\TestSuite as TestSuiteConfiguration;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox\CliTestDoxPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\VersionComparisonOperator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\Exception as XmlException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\Loader as XmlLoader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\SchemaFinder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\Validator;
/**
