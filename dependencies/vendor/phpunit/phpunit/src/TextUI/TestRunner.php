...
use function time;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Exception;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestResult;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestSuite;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\AfterLastTestHook;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\BaseTestRunner;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\BeforeFirstTestHook;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\DefaultTestResultCache;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Extension\ExtensionHandler;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Filter\ExcludeGroupFilterIterator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Filter\Factory;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Filter\IncludeGroupFilterIterator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Filter\NameFilterIterator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Hook;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\NullTestResultCache;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\ResultCacheExtension;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\StandardTestSuiteLoader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\TestHook;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\TestListenerAdapter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\TestSuiteLoader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\TestSuiteSorter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Version;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\FilterMapper;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Configuration;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\Loader;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\TextUI\XmlConfiguration\PhpHandler;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Filesystem;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Log\JUnit;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Log\TeamCity;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Printer;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox\CliTestDoxPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox\HtmlResultPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox\TextResultPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox\XmlResultPrinter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\XdebugFilterScriptGenerator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Xml\SchemaDetector;
use ReflectionClass;
use ReflectionException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\CodeCoverage;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Driver\Selector;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Exception as CodeCoverageException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Filter as CodeCoverageFilter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Clover as CloverReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Cobertura as CoberturaReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Crap4j as Crap4jReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Html\Facade as HtmlReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\PHP as PhpReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Text as TextReport;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeCoverage\Report\Xml\Facade as XmlReport;
        ...
        if (isset($arguments['configurationObject'])) {
            ...
            if (!isset($arguments['noLogging'])) {
                if ($loggingConfiguration->hasText()) {
                    $arguments['listeners'][] = new DefaultResultPrinter($loggingConfiguration->text()->target()->path(), \true);
                }
