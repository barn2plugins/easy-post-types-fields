...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Type\ReflectionMapper;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Type\Type;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Type\UnknownType;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Type\VoidType;
/**
...
final class MockMethod
{
    ...
    public static function fromReflection(ReflectionMethod $method, bool $callOriginalMethod, bool $cloneArguments) : self
    {
        ...
        return new self($method->getDeclaringClass()->getName(), $method->getName(), $cloneArguments, $modifier, self::getMethodParametersForDeclaration($method), self::getMethodParametersForCall($method), (new ReflectionMapper())->fromMethodReturnType($method), $reference, $callOriginalMethod, $method->isStatic(), $deprecation);
    }
