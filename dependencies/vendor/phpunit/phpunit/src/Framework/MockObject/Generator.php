...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Doctrine\Instantiator\Exception\ExceptionInterface as InstantiatorException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\Doctrine\Instantiator\Instantiator;
use Exception;
use Iterator;
use IteratorAggregate;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\InvalidArgumentException;
use ReflectionClass;
use ReflectionMethod;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Template\Exception as TemplateException;
...
final class Generator
{
     ...
     * @throws UnknownTypeException
     */
    public function getMockForAbstractClass(string $originalClassName, array $arguments = [], string $mockClassName = '', bool $callOriginalConstructor = \true, bool $callOriginalClone = \true, bool $callAutoload = \true, array $mockedMethods = null, bool $cloneArguments = \true) : MockObject
    {
     ...
     * @throws UnknownTypeException
     */
    public function getMockForTrait(string $traitName, array $arguments = [], string $mockClassName = '', bool $callOriginalConstructor = \true, bool $callOriginalClone = \true, bool $callAutoload = \true, array $mockedMethods = null, bool $cloneArguments = \true) : MockObject
    {
     ...
     * @throws RuntimeException
     */
    public function generate(string $type, array $methods = null, string $mockClassName = '', bool $callOriginalClone = \true, bool $callAutoload = \true, bool $cloneArguments = \true, bool $callOriginalMethods = \false) : MockClass
    {
        if ($mockClassName !== '') {
     ...
     * @throws RuntimeException
     */
    private function getObject(MockType $mockClass, $type = '', bool $callOriginalConstructor = \false, bool $callAutoload = \false, array $arguments = [], bool $callOriginalMethods = \false, object $proxyTarget = null, bool $returnValueGeneration = \true)
    {
