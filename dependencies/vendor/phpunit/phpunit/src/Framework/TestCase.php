...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Constraint\Exception as ExceptionConstraint;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Constraint\ExceptionCode;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Constraint\ExceptionMessage;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Constraint\ExceptionMessageRegularExpression;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Constraint\LogicalOr;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Error\Deprecated;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Error\Error;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Error\Notice;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Error\Warning as WarningError;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\Generator as MockGenerator;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\MockBuilder;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\MockObject;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\MockObject\Stub;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\BaseTestRunner;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\PhptTestCase;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Exception as UtilException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\GlobalState;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\PHP\AbstractPhpProcess;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Test as TestUtil;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Type;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Comparator\Factory as ComparatorFactory;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Diff\Differ;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Exporter\Exporter;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\GlobalState\ExcludeList;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\GlobalState\Restorer;
...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
    ...
    public function run(TestResult $result = null) : TestResult
    {
        ...
        if ($this->runInSeparateProcess()) {
            ...
            if (defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUNIT_COMPOSER_INSTALL')) {
                $composerAutoload = var_export(PHPUNIT_COMPOSER_INSTALL, \true);
            } else {
                $composerAutoload = '\'\'';
            }
            if (defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\__PHPUNIT_PHAR__')) {
    ...
    private function handleDependencies() : bool
    {
        ...
        foreach ($this->dependencies as $dependency) {
            ...
            if (isset($passed[$dependencyTarget])) {
                if ($passed[$dependencyTarget]['size'] != \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Test::UNKNOWN && $this->getSize() != \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Test::UNKNOWN && $passed[$dependencyTarget]['size'] > $this->getSize()) {
    ...
    private function createGlobalStateSnapshot(bool $backupGlobals) : Snapshot
    {
        ...
        if (!defined('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\PHPUNIT_TESTSUITE')) {
            ...
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\SebastianBergmann\\CodeCoverage');
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\SebastianBergmann\\FileIterator');
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\SebastianBergmann\\Invoker');
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\SebastianBergmann\\Template');
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\SebastianBergmann\\Timer');
            $excludeList->addClassNamePrefix('Symfony');
            $excludeList->addClassNamePrefix('Barn2\\Plugin\\Easy_Post_Types_Fields\\Dependencies\\Doctrine\\Instantiator');
