...
class CliTestDoxPrinter extends TestDoxPrinter
{
    ...
    {
        return trim(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestFailure::exceptionToString($t));
    }
    ...
    {
        $trace = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Filter::getFilteredStacktrace($t);
        if (!$this->colors) {
            return $trace;
        }
        $lines = [];
