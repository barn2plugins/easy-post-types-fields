 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\TestDox;
...
class TestDoxPrinter extends DefaultResultPrinter
{
    ...
    {
        $message = trim(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestFailure::exceptionToString($t));
        if ($message) {
    ...
    {
        return \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Filter::getFilteredStacktrace($t);
    }
