...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\WarningTestCase;
...
final class XmlResultPrinter extends Printer implements TestListener
{
    ...
    public function endTest(Test $test, float $time) : void
    {
        ...
        $inlineAnnotations = \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Test::getInlineAnnotations(get_class($test), $test->getName(\false));
