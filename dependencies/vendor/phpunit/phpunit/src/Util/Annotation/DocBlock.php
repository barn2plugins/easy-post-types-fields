 ...
 */
namespace Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Annotation;
...
use function substr;
use function trim;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PharIo\Version\VersionConstraintParser;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\InvalidDataProviderException;
...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\InvalidDataSetException;
use ReflectionClass;
    ...
    public function requirements() : array
    {
        ...
        foreach ($lines as $line) {
            ...
            if (preg_match(self::REGEX_REQUIRES_VERSION_CONSTRAINT, $line, $matches)) {
                ...
                } catch (\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PharIo\Version\Exception $e) {
