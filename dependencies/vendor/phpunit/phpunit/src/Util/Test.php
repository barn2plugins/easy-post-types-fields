...
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Assert;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\CodeCoverageException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\ExecutionOrderDependency;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\InvalidCoversTargetException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\SelfDescribing;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\TestCase;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Warning;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Runner\Version;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Util\Annotation\Registry;
use ReflectionClass;
use ReflectionException;
use ReflectionMethod;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeUnit\CodeUnitCollection;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeUnit\InvalidCodeUnitException;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\CodeUnit\Mapper;
use Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\SebastianBergmann\Environment\OperatingSystem;
/**
...
final class Test
{
     ...
     */
    public static function describe(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Test $test) : array
    {
    ...
    public static function describeAsString(\Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PHPUnit\Framework\Test $test) : string
    {
        if ($test instanceof SelfDescribing) {
            return $test->toString();
        }
    ...
    public static function getMissingRequirements(string $className, string $methodName) : array
    {
        ...
        if (!empty($required['PHP'])) {
            ...
            $version = new \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PharIo\Version\Version(self::sanitizeVersionNumber(PHP_VERSION));
        ...
        if (!empty($required['PHPUnit'])) {
            ...
            $phpunitVersion = new \Barn2\Plugin\Easy_Post_Types_Fields\Dependencies\PharIo\Version\Version(self::sanitizeVersionNumber(Version::id()));
